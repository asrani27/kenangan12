...
class ImportRekeningBelanja extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:import-rekening-belanja';
     ...
     * @var string
     */
    protected $description = 'Import data rekening belanja dari file Excel ke model Program';
    ...
    {
        $filePath = public_path('excel/rekening_belanja.xlsx');
        ...
        $this->info('Memulai proses import data rekening belanja...');
