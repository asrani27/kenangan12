...
@section('title', 'Tambah PPTK - KENANGAN')

@section('header-title', 'Tambah PPTK')
...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-white">Tambah PPTK Baru</h1>
    <p class="text-slate-400 text-sm mt-1">Isi formulir di bawah untuk menambahkan PPTK baru untuk {{ $skpd->nama }}</p>
</div>

<!-- Create Form -->
<div class="card-gradient rounded-xl p-6 border border-slate-700/50 max-w-2xl">
    <form action="{{ route('skpd.pptk.store') }}" method="POST">
        @csrf
    ...
    <div class="flex items-start">
        ...
        <div>
            ...
            <p class="text-sm text-slate-400 mt-1">
                PPTK akan terhubung secara otomatis dengan SKPD Anda. Pastikan data yang diisi sudah benar dan sesuai.
            </p>
        </div>
    </div>
</div>
